...
| [ai4math-paper-reading/](./ai4math-paper-reading/) | 数学论文阅读：PDF 摄入、论文转 Skill | — | ✅ 可用 |
| [ai4math-computational-mathematics/](./ai4math-computational-mathematics/) | 计算数学：有限元、不变量、最小二乘、代码复现 | — | ✅ 可用 |
| [ai4math-optimization/](./ai4math-optimization/) | 数学优化：LP / MIP / SOCP / CDOpt / COPT | — | ✅ 可用 |
| [ai4math-lean-agents/](./ai4math-lean-agents/) | Lean 4 形式化、证明修复、sorry 补全 | — | ✅ 可用 |
| [ai4math-auto-research/](./ai4math-auto-research/) | 自动数学科研：问题发现、证明蓝图生成与审查 | — | ✅ 可用 |
| [ai4math-evolving/](./ai4math-evolving/) | 进化 Agent：OpenEvolve 实验配置与迭代改进 | — | ✅ 可用 |
| [ai4math-paper-writing/](./ai4math-paper-writing/) | 数学论文写作：起草、修订、结构化与审稿回复 | — | ✅ 可用 |
